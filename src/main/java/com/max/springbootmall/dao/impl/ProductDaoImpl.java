...
import com.max.springbootmall.rowmapper.ProductRowMapper;
...
public class ProductDaoImpl implements ProductDao {
    ...
    public Integer createProduct(ProductRequest productRequest) {
        ...
        map.put("imageUrl",productRequest.getImgUrl());
    ...
    public void updateProduct(Integer productId,ProductRequest productRequest) {
        ...
        String sql = "UPDATE product SET product_name = :productName,category = :category, image_url = :imgUrl, price = :price, stock = :stock,description = :description, last_modified_date = :lastModifiedDate WHERE product_id = :productId";
